...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "state_standards" (
  	...
  	"common_core_state_standard_id" integer NOT NULL,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"states_id" integer,
  	"grades_id" integer,
  	"common_core_codes_id" integer,
  	"common_core_state_standards_id" integer,
  	"state_standards_id" integer,
  	"concepts_id" integer,
  	"concept_universal_questions_id" integer,
  	"learning_outcomes_id" integer,
  	"essential_questions_id" integer,
  	"skills_id" integer,
  	"skill_universal_questions_id" integer,
  ...
  ALTER TABLE "state_standards" ADD CONSTRAINT "state_standards_state_id_states_id_fk" FOREIGN KEY ("state_id") REFERENCES "public"."states"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "state_standards" ADD CONSTRAINT "state_standards_common_core_state_standard_id_common_core_state_standards_id_fk" FOREIGN KEY ("common_core_state_standard_id") REFERENCES "public"."common_core_state_standards"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_state_standards_fk" FOREIGN KEY ("state_standards_id") REFERENCES "public"."state_standards"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "states_state_abbreviation_idx" ON "states" USING btree ("state_abbreviation");
  CREATE UNIQUE INDEX "states_state_name_idx" ON "states" USING btree ("state_name");
  ...
  CREATE UNIQUE INDEX "state_abbreviation_idx" ON "states" USING btree ("state_abbreviation");
  CREATE UNIQUE INDEX "state_name_idx" ON "states" USING btree ("state_name");
  ...
  CREATE INDEX "state_standards_state_idx" ON "state_standards" USING btree ("state_id");
  CREATE INDEX "state_standards_common_core_state_standard_idx" ON "state_standards" USING btree ("common_core_state_standard_id");
  CREATE INDEX "state_standards_updated_at_idx" ON "state_standards" USING btree ("updated_at");
  CREATE INDEX "state_standards_created_at_idx" ON "state_standards" USING btree ("created_at");
  CREATE INDEX "state_common_core_state_standard_idx" ON "state_standards" USING btree ("state_id","common_core_state_standard_id");
  CREATE INDEX "common_core_state_standard_idx" ON "state_standards" USING btree ("common_core_state_standard_id");
  CREATE INDEX "state_idx" ON "state_standards" USING btree ("state_id");
  ...
  CREATE INDEX "concept_sort_idx" ON "concept_universal_questions" USING btree ("concept_id","sort");
  CREATE INDEX "question_type_idx" ON "concept_universal_questions" USING btree ("question_type");
  ...
  CREATE INDEX "concept_sort_1_idx" ON "learning_outcomes" USING btree ("concept_id","sort");
  ...
  CREATE INDEX "concept_sort_2_idx" ON "skills" USING btree ("concept_id","sort");
  ...
  CREATE INDEX "question_type_1_idx" ON "skill_universal_questions" USING btree ("question_type");
  ...
  CREATE INDEX "payload_locked_documents_rels_state_standards_id_idx" ON "payload_locked_documents_rels" USING btree ("state_standards_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "state_standards" CASCADE;
